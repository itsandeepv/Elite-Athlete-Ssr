...
function PurchaseHistory({setshowPopup}) {
                ...
                <div className='border-bottom pb-3 d-lg-flex align-items-center justify-content-between '>
                    ...
                    <div className='' style={{ minWidth: "350px" }}>
                        <div className="form-contr search-input py-lg-2 position-relative">
                            ...
                            <input type="search" className='pl-4' placeholder='Search in Orders' />
                        </div>
                    </div>
                </div>
                    ...
                    <div className='dashboard-address-list p-lg-3'>
                        <div className='text-dark d-flex align-items-center gap-3'>
                            ...
                            <div>
                                ...
                                <p className='gray bold-600'>on Tue, 6 Jan 2024</p>
                            </div>
                        </div>
                        <div className='purchase-container'>
                            <div className='py-3 d-flex justify-content-between align-items-end'>
                                <div className='d-flex gap-3 align-items-center'>
                                    ...
                                    <div >
                                        <h4><b> Quercetion </b></h4>
                                        <p className='gray bold-600 py-2'>500 mg</p>
                                        <p className='gray bold-600'>200 caps</p>
                                    </div>
                                </div>
                                <div className='d-flex  align-items-center gap-3 pt-3'>
                                    <button className='c-btn bg-voilet text-light' onClick={() => { setshowPopup(true) }}>View Details</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='dashboard-address-list p-lg-3 mt-3'>
                        ...
                        <div className='purchase-container'>
                            ...
                            <div className='d-flex justify-content-between align-items-center'>
                                ...
                                <button className='btn border-none bg-white ' onClick={() => { dispatch(handlePopup({test:"data"} , "Add_Review" ,true))}}><b>Write Review</b></button>
                            </div>
                        </div>
                    ...
                    <div className='dashboard-address-list p-lg-3 mt-3'>
                        <div className='text-dark d-flex align-items-center gap-3'>
                            ...
                            <div>
                                ...
                                <p className='gray bold-600'>on Tue, 6 Jan 2024 as per request</p>
                            </div>
                        </div>
                        <div className='purchase-container'>
                            <div className='py-3 d-flex justify-content-between align-items-end'>
