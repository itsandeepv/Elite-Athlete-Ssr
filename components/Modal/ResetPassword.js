...
function ResetPassword({ setShowpopup }) {
    ...
    useEffect(() => {
         if (state?.userData?.phone || (state?.genrateOtp && state?.userData?.phone ))
             { handleSubmit() } }, [])
                        ...
                        <>
                            {
                                showforgotPass ?
                                    ...
                                    :
                                    <p className='forgot-para'>
                                        {(state.popName != "forgotPassword" || state?.newRegister) && (
                ...
                }
                {
                    (otpsend == "otp" || state?.userData) ?
                                ...
                                showforgotPass ?
                                    ...
                                    <>
                                        <div className="form-contr">
                                            <span > 
                                                {
                                                    state?.genrateOtp && state?.userData?.phone ? `Otp send to your register number ${state?.userData?.phone}`:"OTP"
                                                }
                                                {/* OTP */}
                                                </span>
                                            <div>
                        ...
                        state.popName == "forgotPassword" ?
                            ...
                            : state.popName == "forgotPassword" && state?.setnewPassword ?
                                <>
                                    <div className="form-contr">
                                        <label htmlFor="password">New Password</label>
                                        <input type={isPassText ? "text" : "password"} id='password' name='password' value={passformData?.password} onChange={(e) => onChangeHandle(e)} placeholder='Enter your new password' />
                                ...
                                <>
                                    ...
                                    {/* <div className="form-contr">
                                    <label htmlFor="number">Enter Captcha</label>
